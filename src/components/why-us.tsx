...
const points = [
  {
    icon: HeartHandshake,
    title: 'Family-owned',
    description: 'Run by Paul & Kirsty Saunderson — the same people who answer the phone do the walk-throughs.',
  },
  {
    icon: Users,
    title: 'In-house trades',
    description: 'A qualified team backed by long-trusted contractors. No subletting your job to strangers.',
  },
  {
    icon: ShieldCheck,
    title: 'WHS compliant',
  ...
  },
  {
    icon: Award,
    title: 'Track record',
    description: 'Long-standing relationships with aged care, child care, retail centres and government.',
  },
]
...
export default function WhyUs() {
  return (
    <section className="relative overflow-hidden bg-navy-900 py-20 text-white sm:py-28">
      <div
        className="absolute -top-32 -right-32 size-96 rounded-full bg-orange-brand/20 blur-3xl"
        aria-hidden
      />
      <div
        className="absolute -bottom-32 -left-32 size-96 rounded-full bg-navy-500/30 blur-3xl"
        aria-hidden
      />
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-10">
        <div className="max-w-2xl">
          ...
          <h2 className="mt-3 font-display text-3xl leading-tight font-black tracking-tight text-balance sm:text-4xl lg:text-5xl">
