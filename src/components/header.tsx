    ...
    <>
      <header
        className={`fixed inset-x-0 top-0 z-50 transition-all duration-300 ${
          scrolled ? 'bg-navy-700/95 shadow-lg backdrop-blur-md' : 'bg-transparent'
        }`}>
        <div className='mx-auto flex max-w-7xl items-center justify-between px-4 py-3 sm:px-6 lg:px-10'>
          ...
          <nav className='hidden items-center gap-1 lg:flex'>
            ...
            <a
              href={phoneHref}
              className='ml-2 inline-flex items-center gap-2 rounded-full bg-orange-brand px-5 py-2.5 text-sm font-bold text-white shadow-cta transition hover:bg-orange-brand-hover'>
