    ...
    <section className="relative isolate overflow-hidden bg-navy-900 text-white">
      ...
      <div className="mx-auto max-w-7xl px-4 pt-32 pb-20 sm:px-6 sm:pt-40 sm:pb-28 lg:px-10 lg:pt-44 lg:pb-36">
        <div className="max-w-3xl">
          ...
          >
            Canberra&apos;s trusted{' '}
            <span className="text-orange-brand">property contractors</span>.
          </motion.h1>
          ...
          >
            ...
            <a
              href={phoneHref}
              className="inline-flex items-center justify-center gap-2 rounded-full border border-white/25 bg-white/5 px-7 py-4 text-base font-bold text-white backdrop-blur transition hover:bg-white/10"
            >
          ...
          <motion.dl
            ...
            className="mt-14 grid max-w-2xl grid-cols-2 gap-x-6 gap-y-6 sm:mt-20 sm:grid-cols-3"
          >
            {[
