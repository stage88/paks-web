        ...
        <motion.div
          ...
          <div className='relative flex flex-col gap-8 lg:flex-row lg:items-center lg:justify-between'>
            <div className='max-w-2xl'>
              ...
              <h2 className='mt-3 font-display text-3xl/tight font-black tracking-tight text-balance text-white sm:text-4xl lg:text-5xl'>
            ...
            <div className='flex shrink-0 flex-col gap-3 sm:flex-row lg:flex-col lg:items-end'>
              <a
                href={phoneHref}
                className='inline-flex items-center justify-center gap-2 rounded-full bg-navy-900 px-7 py-4 text-base font-bold whitespace-nowrap text-white shadow-xl transition hover:bg-navy-800'>
                <Phone className='size-5' aria-hidden />
                {siteMetadata.phone}
              </a>
              <a
                href={`mailto:${siteMetadata.email}?subject=Quote%20request`}
                className='group inline-flex items-center justify-center gap-2 rounded-full bg-white px-7 py-4 text-base font-bold whitespace-nowrap text-navy-900 shadow-xl transition hover:bg-white/95'>
                Email a quote
