  ...
  return (
    <>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-10">
          ...
          <div className="mt-6 grid gap-10 lg:grid-cols-12 lg:items-end">
            ...
            <p className="text-base leading-relaxed text-white/75 sm:text-lg lg:col-span-5">
              ...
              ought to be done — straight talk, qualified hands, and a finish you&apos;d be proud
              to put your name on.
            </p>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-10">
          <div className="grid gap-12 lg:grid-cols-2 lg:gap-16">
            <div>
              ...
              <h2 className="mt-3 font-display text-3xl leading-tight font-black tracking-tight text-navy-900 sm:text-4xl">
      ...
      <section className="bg-navy-50 py-16 sm:py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-10">
          <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
            <h2 className="font-display text-2xl font-black tracking-tight text-navy-900 sm:text-3xl">
              Credentials &amp; compliance
            </h2>
            <p className="text-sm text-ink-soft">All current, all auditable, on request.</p>
          </div>
          <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {credentials.map((c) => (
              <div
                key={c.label}
                className="flex items-start gap-4 rounded-2xl border border-navy-100 bg-white p-5"
              >
      ...
      <section className="bg-paper py-16 sm:py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-10">
          <div className="flex flex-col items-start justify-between gap-6 rounded-3xl border border-navy-100 bg-white p-8 sm:flex-row sm:items-center sm:p-10">
            <div>
              <h3 className="font-display text-2xl font-black tracking-tight text-navy-900 sm:text-3xl">
                Ready when you are.
              </h3>
